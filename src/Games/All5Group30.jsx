...
function All5Group30({ gameDescription }) {
  ...
  const row1Combination = getCombinations1(firstArray, 2);
  const row2Combination = getCombinations1(secondArray, 1);
  ...
  const showResults = () => {
    ...
    let counter = 0;
    row2Combination.forEach((number) => {
      row1Combination.forEach((value) => {
