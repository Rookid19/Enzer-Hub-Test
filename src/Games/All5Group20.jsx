...
function All5Group20({ gameDescription }) {
  ...
  const { getCombinations1 ,getNumCombinations } = useFormula();
  ...
  const row2Combination = getCombinations1(secondArray, 2);
  ...
  const showResults = () => {
    ...
    console.log("f "+getNumCombinations(firstArray,1));
    console.log("s " + getNumCombinations(secondArray,3));
